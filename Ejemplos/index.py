...
class Product:
    ...
    def __init__ (self, window):
        ...
        #Frame container
        frame = LabelFrame(self.wind, text = "Products Application")
        ...
        #Button Add Product
        ttk.Button(frame, text = "Save Products", command = self.add_product).grid(row = 3, columnspan = 2, sticky = W + E)
    ...
    def validation_add(self):
        return len(self.name.get()) != 0 and len(self.price.get()) != 0

    def validation_del(self):
        return len(self.tree.item(self.tree.selection())["text"]) != 0 
